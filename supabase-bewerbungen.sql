-- =====================================================================
-- ALWA Karriereseite: Storage-Bucket für den optionalen Lebenslauf-Upload
-- ---------------------------------------------------------------------
-- Einmalig im Supabase SQL-Editor ausführen (Projekt kxqdybjkcrowqdcpvlqa).
-- Danach kann die Landingpage kunden/alwa/ Dateien in den Bucket
-- "bewerbungen" hochladen; der Link landet im Leadtable-Datensatz.
--
-- Sicherheit:
